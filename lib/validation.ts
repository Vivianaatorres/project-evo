...
export const PatientFormValidation = z.object({
  ...
  emergencyContactName: z
    ...
    .max(50, "El nombre del contacto debe tener como máximo 50 caracteres."),
  ...
  treatmentConsent: z
    ...
    .refine((value) => value === true, {
      message: "Debe dar su consentimiento al tratamiento para poder continuar.",
    }),
  disclosureConsent: z
    .boolean()
    .default(false)
    .refine((value) => value === true, {
      message: "Debe dar su consentimiento a la divulgación para poder continuar.",
    }),
  privacyConsent: z
    .boolean()
    .default(false)
    .refine((value) => value === true, {
      message: "Debes dar tu consentimiento a la privacidad para poder continuar.",
    }),
});
