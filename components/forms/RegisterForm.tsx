      ...
      >
        ...
        <section className="space-y-6">
          ...
          <div className="flex flex-col gap-6 xl:flex-row">
            <CustomFormField
              ...
              placeholder="Rimac Seguros, Pacifico Seguros"
            />
          ...
          <div className="flex flex-col gap-6 xl:flex-row">
            ...
            <CustomFormField
              ...
              placeholder="Ibuprofeno 200 mg, Levotiroxina 50 mcg"
            />
          </div>
        ...
        <section className="space-y-6">
          ...
          <CustomFormField
            ...
            label="Doy mi consentimiento para el uso y divulgación de mi salud.
            información para fines de tratamiento."
          />
